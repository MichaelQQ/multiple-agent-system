...
from ..cost_helpers import aggregate_costs_by_role, at_risk_tasks, compute_burn_rate, forecast_exhaustion_days
...
def create_app(project: Path | None = None) -> FastAPI:
    ...
    def stats_view(request: Request, since: str | None = None):
        ...
        try:
            ...
            # Fallback: parse config yaml directly to get forecast settings
            try:
                import yaml
