"""Tests for docs/testing-strategy.md documentation."""
from pathlib import Path

import pytest

REPO_ROOT = Path(__file__).parent.parent
TESTING_STRATEGY_PATH = REPO_ROOT / "docs" / "testing-strategy.md"


def get_strategy_content_or_fail():
    """Get content or fail with clear error."""
    if not TESTING_STRATEGY_PATH.exists():
        pytest.fail(f"docs/testing-strategy.md not found at {TESTING_STRATEGY_PATH}")
    return TESTING_STRATEGY_PATH.read_text()


class TestTestingStrategyDocument:
    """Tests validating the existence and content of docs/testing-strategy.md."""

    def test_testing_strategy_md_exists(self):
        """docs/testing-strategy.md must exist."""
        assert TESTING_STRATEGY_PATH.exists(), (
            f"docs/testing-strategy.md not found at {TESTING_STRATEGY_PATH}"
        )
    ...
    def test_has_unit_tests_section(self):
        ...
        assert "Unit Tests" in content, (
            "docs/testing-strategy.md must contain a 'Unit Tests' section"
        )
    ...
    def test_has_integration_tests_section(self):
        ...
        assert "Integration Tests" in content, (
            "docs/testing-strategy.md must contain an 'Integration Tests' section"
        )
    ...
    def test_has_e2e_tests_section(self):
        ...
        assert has_e2e, (
            "docs/testing-strategy.md must contain an 'E2E Tests' or 'End-to-End' section"
        )
    ...
    def test_mentions_board_py(self):
        ...
        assert "board.py" in content, (
            "docs/testing-strategy.md must mention board.py with layer assignment"
        )
    ...
    def test_mentions_tick_py(self):
        ...
        assert "tick.py" in content, (
            "docs/testing-strategy.md must mention tick.py with layer assignment"
        )
    ...
    def test_mentions_adapters(self):
        ...
        assert "adapters/" in content, (
            "docs/testing-strategy.md must mention adapters/ with layer assignment"
        )
    ...
    def test_has_mocking_section(self):
        ...
        assert has_mock_section, (
            "docs/testing-strategy.md must include a section on mocking external services "
    ...
    def test_mentions_ollama_or_external_api(self):
        ...
        assert has_ollama or has_external, (
            "docs/testing-strategy.md should mention Ollama/external APIs in mocking context"
        )
    ...
    def test_references_existing_test_files(self):
        ...
        assert has_any_reference, (
            "docs/testing-strategy.md must reference existing test files "
